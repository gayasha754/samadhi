                            ...
                            <form id="insert_form" class="form-horizontal" method="POST" ><!-- form-horizantal starts-->
                                ...
                                <div class="form-group"><!--form-group starts-->
                                    ...
                                    <div class="col-md-6"><!--col-md-6 starts-->
                                        ...
                                        <input type="text" name="Sname" id="donarname" class="form-control"  value="<?php echo $iName ?>" required>
                                ...
                                <div class="form-group"><!--form-group starts-->
                                    ...
                                    <div class="col-md-6"><!--col-md-6 starts-->
                                          ...
                                          <input type="text" name="contactNo" id="contactNo" class="form-control" value="<?php echo $cNumber ?>" required>
